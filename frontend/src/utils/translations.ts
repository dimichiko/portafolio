export const translations = {
  es: {
    hero: {
      title: "Hola, soy",
      name: "Dimitris Vamvoukas",
      subtitle: "Desarrollador Full-Stack MERN & TypeScript",
    ...
    contact: {
      ...
      subtitle: "Actualmente estoy buscando nuevas oportunidades. Ya sea que tengas una pregunta o solo quieras saludar, ¡te responderé lo antes posible!",
      name: "Nombre",
      email: "Email",
      message: "Mensaje",
    ...
    stats: {
      ...
      subtitle: "Análisis del tráfico del portfolio",
      totalVisits: "Total de Visitas",
      visitsByDay: "Visitas por Día (últimos 7 días)",
      topCountries: "Top Países",
      dateSummary: "Resumen por Fecha",
      lastUpdate: "Última actualización",
      loading: "Cargando estadísticas...",
      noVisits: "Aún no hay visitas registradas",
      noVisitsSubtitle: "Las estadísticas aparecerán aquí cuando recibas visitas.",
      noRecentData: "Aún sin datos de tráfico reciente",
      noCountryData: "Aún sin datos de país detectados",
      backToHome: "← Volver al Inicio",
      visits: "visitas",
      date: "Fecha"
    },
    footer: {
      copyright: "© 2025 Dimitris Vamvoukas. Todos los derechos reservados."
    }
  },
  en: {
    hero: {
      title: "Hi, I'm",
      name: "Dimitris Vamvoukas",
      subtitle: "Full-Stack MERN & TypeScript Developer",
    ...
    contact: {
      title: "Get In Touch",
      subtitle: "I'm currently looking for new opportunities. Whether you have a question or just want to say hi, I'll get back to you as soon as possible!",
      name: "Name",
      email: "Email",
      message: "Message",
    ...
    stats: {
      ...
      subtitle: "Portfolio traffic analysis",
      totalVisits: "Total Visits",
      visitsByDay: "Visits by Day (last 7 days)",
      topCountries: "Top Countries",
      dateSummary: "Summary by Date",
      lastUpdate: "Last update",
      loading: "Loading statistics...",
      noVisits: "No visits recorded yet",
      noVisitsSubtitle: "Statistics will appear here when you receive visits.",
      noRecentData: "No recent traffic data yet",
      noCountryData: "No country data detected yet",
      backToHome: "← Back to Home",
      visits: "visits",
      date: "Date"
    },
    footer: {
      copyright: "© 2025 Dimitris Vamvoukas. All rights reserved."
    }
  }
}; 